module.exports = function(grunt) {
    ...
    var average_markDirPath = 'components/average_mark/';
    var find_best_bookDirPath = 'components/find_best_book/';
    ...
    grunt.initConfig({
        concat: {
            ...
            average_mark: {
                src: [average_markDirPath + 'src/average_mark-common.js',
                    average_markDirPath + 'src/average_mark-component.js',
                    average_markDirPath + 'src/average_mark-paintPanel.js'
                ],
                dest: average_markDirPath + 'static/components/js/average_mark/average_mark.js'
            },
		find_best_book: {
                src: [find_best_bookDirPath + 'src/find_best_book-common.js',
                    find_best_bookDirPath + 'src/find_best_book-component.js',
                    find_best_bookDirPath + 'src/find_best_book-paintPanel.js'
                ],
                dest: find_best_bookDirPath + 'static/components/js/find_best_book/find_best_book.js'
            },			
        },
        ...
        copy: {
            ...
            average_markJs: {
                cwd: average_markDirPath + 'static/components/js/average_mark/',
                src: 'average_mark.js',
                dest: clientJsDirPath + 'average_mark/',
                expand: true,
                flatten: true
            },
	           average_markCss: {
                cwd: average_markDirPath + 'static/components/css/average_mark/',
                src: 'average_mark.css',
                dest: clientCssDirPath,
                expand: true,
                flatten: true
            },
            average_markHtml: {
                cwd: average_markDirPath + 'static/components/html/average_mark/',
                src: 'average_mark-main-page.html',
            ...
            find_best_bookJs: {
                cwd: find_best_bookDirPath + 'static/components/js/find_best_book/',
                src: 'find_best_book.js',
                dest: clientJsDirPath + 'find_best_book/',
                expand: true,
                flatten: true
            },
	           find_best_bookCss: {
                cwd: find_best_bookDirPath + 'static/components/css/find_best_book/',
                src: 'find_best_book.css',
                dest: clientCssDirPath,
                expand: true,
                flatten: true
            },
            find_best_bookHtml: {
                cwd: find_best_bookDirPath + 'static/components/html/find_best_book/',
                src: 'find_best_book.html',
                dest: clientHtmlDirPath,
                expand: true,
                flatten: true
            },
        ...
        watch: {
            ...
            average_markJs: {
                files: average_markDirPath + 'src/**',
                tasks: ['concat:average_mark', 'copy:average_markJs'],
            },

            find_best_bookJs: {
                files: average_markDirPath + 'src/**',
                tasks: ['concat:find_best_book', 'copy:find_best_bookJs'],
            },
            githubCss: {
