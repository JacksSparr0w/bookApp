...
append_js $sc_web_path/templates/components.html components/js/search_book_by_rating_component/search_book_by_rating_component.js
append_css $sc_web_path/templates/components.html components/css/search_book_by_rating_component.css
